...
type LoadNotification struct {
	...
	Metric       string      `json:"metric" gorm:"type:varchar(50);not null;default:'cpu'"`
	Threshold    float32     `json:"threshold" gorm:"type:decimal(5,2);not null;default:80.00"`
	Ratio        float32     `json:"ratio" gorm:"type:decimal(5,2);not null;default:0.80"`
	Interval     int         `json:"interval" gorm:"type:int;not null;default:15"`
