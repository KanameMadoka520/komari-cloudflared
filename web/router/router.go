...
func registerAgentRoutes(r *gin.Engine) {
	...
	{
		// Legacy agents share the current auth and normalized ingestion pipeline.
...
func registerAdminRoutes(r *gin.Engine) {
	...
	{
		settings.GET("/cloudflared", admin.GetCloudflaredStatus)
		settings.POST("/cloudflared/token", admin.SaveCloudflaredToken)
		settings.POST("/cloudflared/start", admin.StartCloudflared)
		settings.POST("/cloudflared/stop", admin.StopCloudflared)
		settings.POST("/cloudflared/remove-token", admin.RemoveCloudflaredToken)
